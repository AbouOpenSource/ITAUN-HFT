from menory_manegement import Transition, ReplayMemory
...
class Agent:
    def __init__(self, state_size=14, T=96, is_eval=True):
        ...
        self.gamma = 0.99
        # Gamma is the value of future reward. It can affect learning quite a bit, and can be a dynamic or static value.
        self.epsilon = 1.0
        self.batch_size = 16
